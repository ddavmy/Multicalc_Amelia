...
{block name=content}
	...
	<div id="main">
		...
		<section class="figuraTrójkąt">
			<form action="{rel_url action="POtrCompute#formularz"}" method="post" id="form">
				<div>
					<div class="col">
						...
						<div id="submit" class="col-6">
							<ul class="actions" >
								...
								<li><a class="button" href="{rel_url action="POtrShow"}">Odśwież</a></li>
							</ul>
						</div>
						<div class="col-6">
						</div>
			...
			{strip}
				<tr>
					...
					<td>{$r["username"]}</td>
					<td>
						<a class="button" id="recordDelete" href="{rel_url action="POtrDelete" id=$r['id']}#form">Usuń</a>
					</td>
					{/if}
				</tr>
			{/strip}
