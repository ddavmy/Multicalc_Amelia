...
{block name=content}
	...
	<div id="main">
		...
		<section class="figuraRomb">
			<form action="{rel_url action="Romb"}" method="post" id="form">
				<div>
					<div class="col">
						...
						<div class="col-6 col-12-medium">
							<input type="text" name="dlugoscB" autocomplete="off" placeholder="Długość h" value="{$form->dlugoscB}"/>
						</div>
						<div id="submit" class="col-6">
							<ul class="actions" >
								<li><input type="submit" name="submit" class="button" value="Oblicz" /></li>
								<li><a class="button" href="{rel_url action="Romb"}">Odśwież</a></li>
							</ul>
						</div>
						<div class="col-6">
						</div>
			...
			{strip}
				<tr>
					...
					<td>{$r["username"]}</td>
					<td>
						<form action="{rel_url action="Romb" id=$r['id']}#form" method="post">
