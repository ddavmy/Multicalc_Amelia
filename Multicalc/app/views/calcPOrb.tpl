...
{block name=content}
	...
	<div id="main">
		...
		<section class="figuraRomb">
			<form action="{rel_url action="POrbCompute#formularz"}" method="post" id="form">
				<div>
					<div class="col">
						...
						<div id="submit" class="col-6">
							<ul class="actions" >
								...
								<li><a class="button" href="{rel_url action="POrbShow"}">Odśwież</a></li>
							</ul>
						</div>
						<div class="col-6">
						</div>
			...
			{strip}
				<tr>
					...
					<td>{$r["username"]}</td>
					<td>
						<a class="button" id="recordDelete" href="{rel_url action="POrbDelete" id=$r['id']}#form">Usuń</a>
					</td>
					{/if}
				</tr>
			{/strip}
