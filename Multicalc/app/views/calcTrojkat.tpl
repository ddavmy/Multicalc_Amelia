...
{block name=content}
	...
	<div id="main">
		...
		<section class="figuraTrojkat">
			<form action="{rel_url action="Trojkat"}" method="post" id="form">
				<div>
					<div class="col">
						...
						<div class="col-6 col-12-medium">
							<input type="text" name="dlugoscD" autocomplete="off" placeholder="Długość h" value="{$form->dlugoscD}"/>
						</div>
						<div id="submit" class="col-6">
							<ul class="actions" >
								<li><input type="submit" name="submit" class="button" value="Oblicz" /></li>
								<li><a class="button" href="{rel_url action="Trojkat"}">Odśwież</a></li>
							</ul>
						</div>
						<div class="col-6">
						</div>
			...
			{strip}
				<tr>
					...
					<td>{$r["username"]}</td>
					<td>
						<form action="{rel_url action="Trojkat" id=$r['id']}#form" method="post">
