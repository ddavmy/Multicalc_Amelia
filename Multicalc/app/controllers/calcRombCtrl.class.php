...
class calcRombCtrl {
    ...
    public function validate() {
        ...
        if($this->form->dlugoscB <= 0) {
            Utils::addErrorMessage('Długość h musi być większa od 0');
    ...
    public function RombCompute(){
        if ($this->validate()) {
            ...
            $this->result->wynikB = round(4 * $this->form->dlugoscA, 2);
    ...
    public function generateView(){
        ...
        App::getSmarty()->display('calcRomb.tpl');
    }
