...
class calcTrojkatCtrl {
    ...
    public function validate() {
        ...
        } elseif(!is_numeric($this->form->dlugoscD)) {
    ...
    public function action_Trojkat() {
        $this->getParams();
    ...
    public function TrojkatCompute() {
        if ($this->validate()) {
            ...
            $this->result->wynikA = round(($this->form->dlugoscA * $this->form->dlugoscD) / 2, 2);
            Utils::addWynikMessage('Pole = '.$this->result->wynikA);

            $this->result->wynikB = round($this->form->dlugoscA + $this->form->dlugoscB + $this->form->dlugoscC, 2);
    ...
    public function generateView() {
        ...
        App::getSmarty()->display('calcTrojkat.tpl');
    }
