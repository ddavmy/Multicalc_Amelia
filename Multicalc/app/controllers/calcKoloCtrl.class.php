...
class calcKoloCtrl {
    ...
    public function KoloCompute(){
        if ($this->validate()) {
            ...
            $this->result->wynikA = round($pi * $this->form->dlugoscA * $this->form->dlugoscA, 2);
            Utils::addWynikMessage('Pole = '.$this->result->wynikA);

            $this->result->wynikB = round(2 * $pi * $this->form->dlugoscA, 2);
    ...
    public function generateView(){
        ...
        App::getSmarty()->display('calcKolo.tpl');
    }
